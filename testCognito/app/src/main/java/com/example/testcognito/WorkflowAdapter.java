...
public class WorkflowAdapter extends RecyclerView.Adapter<WorkflowAdapter.ViewHolder> {
    ...
    private List<ListWorkflowsQuery.Item> mData = new ArrayList<>();;
    ...
    public void setItems(List<ListWorkflowsQuery.Item> items) {
        mData = items;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindData(ListWorkflowsQuery.Item item) {
